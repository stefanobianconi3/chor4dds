...
import ChangeMessage from './cmd/ChangeMessage';
...
ChoreoModeling.prototype.getHandlers = function() {
  ...
  handlers['message.change'] = ChangeMessage; 
...
ChoreoModeling.prototype.changeMessage = function(bandShape, message, parent) {
  this._commandStack.execute('message.change', {
    bandShape: bandShape,
    newMessage: message,
    parent: parent
  });
