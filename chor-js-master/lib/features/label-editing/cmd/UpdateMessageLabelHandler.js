 ...
 */
export default function UpdateMessageLabelHandler(injector, elementRegistry, eventBus) {
  ...
  this.execute = function(context) {
    if (is(context.element, 'bpmn:Message')) {
      let shape = context.element.businessObject;
      let bandShapes = elementRegistry.filter((element, gfx) => element.businessObject === shape);
